...
#define _DEFINE_H_
#include "TOP_LEVEL.h"
//#include <Windows.h>  // allen 20170719
//#include <winbase.h>
#include "types.h"
#include <stdint.h>  // allen add 20170718
#include <vector>
#include <QtCore/qglobal.h>  // allen for Q_DECL_EXPORT
...
#endif
*/
 #define MP5000_API extern "C" Q_DECL_EXPORT  //allen
// #define MP5000_API	 extern "C" __declspec(dllexport)   // export to DLL to remove .def
// #define MP5000_API	 extern "C" __attribute__((dllexport))   // export to DLL to remove .def
